...
public abstract class AbstractRotateableWaterLoggableBlock extends Block implements IWaterLoggable {
   public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;
   public static final DirectionProperty FACING = HorizontalBlock.field_185512_D;
  
  public AbstractRotateableWaterLoggableBlock(AbstractBlock.Properties properties) {
     super(properties);
     func_180632_j((BlockState)((BlockState)((BlockState)this.field_176227_L.func_177621_b()).func_206870_a((Property)FACING, (Comparable)Direction.NORTH)).func_206870_a((Property)WATERLOGGED, Boolean.valueOf(false)));
  }
  ...
  public BlockState func_196258_a(BlockItemUseContext context) {
     ...
     return (BlockState)((BlockState)getDefaultState().func_206870_a((Property)FACING, (Comparable)context.func_195992_f().getOpposite())).func_206870_a((Property)WATERLOGGED, Boolean.valueOf((fluidstate.func_206886_c() == Fluids.field_204546_a)));
  }
  ...
  protected void func_206840_a(StateContainer.Builder<Block, BlockState> state) {
     state.func_206894_a(new Property[] { (Property)FACING, (Property)WATERLOGGED });
  }
}
