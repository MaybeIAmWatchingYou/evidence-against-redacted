...
public class RustableRoundelBlock extends RoundelBlock implements IRust {
  public RustableRoundelBlock(AbstractBlock.Properties properties) {
  ...
  public BlockState getRustedState(BlockState state) {
     return (BlockState)super.getRustedState(state)
       .func_206870_a((Property)FACING, state.get((Property)FACING));
  }
