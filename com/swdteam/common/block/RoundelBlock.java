...
public class RoundelBlock extends AbstractFacingBlock {
  public RoundelBlock(AbstractBlock.Properties properties) {
     super(properties);
  ...
  public RoundelBlock(AbstractBlock.Properties properties, int light) {
     this(properties.func_235838_a_(state -> light));
  }
  ...
  public BlockState func_196258_a(BlockItemUseContext context) {
     double rot = (context.func_195992_f().getOpposite().func_185119_l() + (context.func_195999_j().func_225608_bj_() ? 90 : false));
     return (BlockState)getDefaultState().func_206870_a((Property)FACING, (Comparable)Direction.func_176733_a(rot));
  }

  public static class WaterLoggable
    extends RoundelBlock
