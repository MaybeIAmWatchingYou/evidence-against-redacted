...
public class CybermanTombStructure extends Structure<NoFeatureConfig> {
  public CybermanTombStructure(Codec<NoFeatureConfig> codec) {
     super(codec);
  }
