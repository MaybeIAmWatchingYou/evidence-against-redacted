...
public class Meteorite3Structure extends Structure<NoFeatureConfig> {
  public Meteorite3Structure(Codec<NoFeatureConfig> codec) {
     super(codec);
  }
  ...
  public static class Start extends StructureStart<NoFeatureConfig> {
    ...
    public void generatePieces(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
       ...
       BlockPos blockpos = new BlockPos(x, -6, z);

       JigsawManager.func_242837_a(dynamicRegistryManager, new VillageConfig(() -> (JigsawPattern)dynamicRegistryManager.func_243612_b(Registry.field_243555_ax).getOrDefault(new ResourceLocation("dalekmod", "meteorite_3/start_pool")), 10), net.minecraft.world.gen.feature.structure.AbstractVillagePiece::new, chunkGenerator, templateManagerIn, blockpos, this.field_75075_a, (Random)this.field_214631_d, false, true);
