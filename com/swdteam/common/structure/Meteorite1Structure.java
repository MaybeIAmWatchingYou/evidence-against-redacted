...
public class Meteorite1Structure extends Structure<NoFeatureConfig> {
  public Meteorite1Structure(Codec<NoFeatureConfig> codec) {
     super(codec);
  }
