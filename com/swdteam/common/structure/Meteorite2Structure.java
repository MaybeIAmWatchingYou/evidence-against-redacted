...
public class Meteorite2Structure extends Structure<NoFeatureConfig> {
  public Meteorite2Structure(Codec<NoFeatureConfig> codec) {
     super(codec);
  }
