...
{
   public static final ResourceLocation TYPE_ID = new ResourceLocation("dalekmod", "engineering_table");
  
  private final NonNullList<Ingredient> ingredients;
  private final ItemStack result;
  private final ResourceLocation id;
  
  public EngineeringTableRecipe(ResourceLocation id, NonNullList<Ingredient> ingredients, ItemStack result) {
     this.id = id;
  ...
  public IRecipeSerializer<?> func_199559_b() {
     return (IRecipeSerializer)DMCraftingTypes.ENGINEERING_SERIALIZER.get();
  }
  ...
  public static class EngineeringTableRecipeType implements IRecipeType<EngineeringTableRecipe> {
    public String toString() {
       return EngineeringTableRecipe.TYPE_ID.toString();
    } }
  
  public static class Serializer extends ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<EngineeringTableRecipe> {
    public EngineeringTableRecipe fromJson(ResourceLocation location, JsonObject json) {
       ...
       if (nonnulllist.size() > 3) {
         throw new JsonParseException("Too many ingredients for engineering table recipe the max is 3");
      }
       ItemStack itemstack = ShapedRecipe.func_199798_a(JSONUtils.func_152754_s(json, "result"));
       return new EngineeringTableRecipe(location, nonnulllist, itemstack);
    }
    ...
    public EngineeringTableRecipe fromNetwork(ResourceLocation location, PacketBuffer buffer) {
    ...
    public void toNetwork(PacketBuffer buffer, EngineeringTableRecipe recipe) {
