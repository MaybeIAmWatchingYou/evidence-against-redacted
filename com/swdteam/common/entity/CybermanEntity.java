...
public class CybermanEntity
  extends MonsterEntity
  implements IRangedAttackMob, IForgeEntity {
  ...
  public CybermanEntity(EntityType<? extends MonsterEntity> type, World worldIn) {
     super(type, worldIn);
  }
  ...
  public void func_70645_a(DamageSource p_70645_1_) {
     ...
     if (!this.world.isRemote())
    {
       if (SWDMathUtils.randomRange(1.0F, 7.0F) == 3.0F)
      {
         for (int e = 0; e < SWDMathUtils.randomRange(1.0F, 3.0F); e++) {
          
           CybermatEntity endermite = (CybermatEntity)((EntityType)DMEntities.CYBERMAT_ENTITY.get()).func_220331_a((ServerWorld)this.world, null, null, new BlockPos(getPositionVec()), SpawnReason.NATURAL, true, true);
           endermite.func_70012_b(getPosX(), getPosY(), getPosZ(), getRotationYawHead(), func_70646_bf());
           endermite.addVelocity(SWDMathUtils.randomDouble(-0.4D, 0.4D), 0.5D, SWDMathUtils.randomDouble(-0.4D, 0.4D));
           endermite.func_184185_a(SoundEvents.field_203253_U, SWDMathUtils.randomRange(0.6F, 1.0F), SWDMathUtils.randomRange(0.6F, 1.0F));
           this.world.addEntity((Entity)endermite);
        } 
      }
    }
  }
  ...
  public void func_241847_a(ServerWorld level, LivingEntity target) {
     ...
     if ((level.func_175659_aa() == Difficulty.NORMAL || level.func_175659_aa() == Difficulty.HARD) && target instanceof VillagerEntity && ForgeEventFactory.canLivingConvert(target, (EntityType)DMEntities.CYBERMAN_ENTITY.get(), timer -> { 
