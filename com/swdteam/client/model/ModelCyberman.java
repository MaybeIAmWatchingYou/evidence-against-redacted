...
public class ModelCyberman
  extends BipedModel<CybermanEntity> implements IModelPartReloader {
  public JSONModel model;
  
  public ModelCyberman(float modelSize) {
     super(modelSize);
  ...
  public void setupAnim(CybermanEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
  ...
  public void init() {
     this.model = ModelLoader.loadModel(new ResourceLocation("dalekmod", "models/entity/cyber/cyberman.json"));
     if (this.model != null) {
