  ...
  implements IModelPartReloader
{
  ...
  public void init() {
     this.model = ModelLoader.loadModel(new ResourceLocation("dalekmod", "models/entity/projectile/laser.json"));
     if (this.model != null)
       this.laser = (ModelRenderer)this.model.getModelData().getModel().getPart("Laser");
  }
}
