...
public class ModelOod
  extends BipedModel<OodEntity>
  implements IModelPartReloader
{
  public JSONModel model;

  public ModelOod(float modelSize) {
     super(modelSize);
  ...
  public void setupAnim(OodEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
     super.func_225597_a_((LivingEntity)entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
  }


  public void init() {
     this.model = ModelLoader.loadModel(new ResourceLocation("dalekmod", "models/entity/ood.json"));
     if (this.model != null) {
