...
public class RenderWoodenScanner extends TileEntityRenderer<WoodenScannerTileEntity> implements IModelPartReloader {
  ...
  public RenderWoodenScanner(TileEntityRendererDispatcher dispatcher) {
     super(dispatcher);
     ModelReloaderRegistry.register(this);
  }

  
  public void render(WoodenScannerTileEntity te, float partialTicks, MatrixStack matrixStack, IRenderTypeBuffer iRenderTypeBuffer, int combinedLightIn, int combinedOverlayIn) {
  ...
  public void init() {
     MODEL_SCANNER = ModelLoader.loadModel(new ResourceLocation("dalekmod", "models/tileentity/wooden_scanner.json"));
  }
